...
<title><?php @$name = str_replace('_', ' ', @$_REQUEST["crichd"]); echo @$name; ?> | Extra-Tv-Team</title>
...
.loading {
    ...
    .plyr__video-wrapper::after {
        ...
        height: 115px;
        width: 115px;
        background: url('https://i.imgur.com/NU0XdZv.jpg') no-repeat;
        background-size: 75px auto, auto;
    }
...
<video autoplay controls crossorigin poster="https://i.imgur.com/NU0XdZv.jpg" playsinline>
<?php
printf("<source type=\"application/vnd.apple.mpegurl\" src=\"master.m3u8/?key=Extra-Tv&c=%s\">", $_REQUEST["cricid"]);
?>
</video>
</body>
<script>
